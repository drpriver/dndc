...
-(void)recalc_html:(NSString*)string{
    ...
    error_text.editable = YES;
    [[error_text textStorage].mutableString setString:@""];
    auto err = run_the_dndc(flags, base_dir, LS_to_SV(source), SV(""), outputpath, &html, BASE64CACHE, TEXTCACHE, show_errors?gdndc_error_func:NULL, show_errors?(__bridge void*)error_text:NULL, cache_watch_files, NULL, gdndc_ast_func, (__bridge void*)self, (WorkerThread*)B64WORKER);
